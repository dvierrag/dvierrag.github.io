...
|----------|--------|--------|-----------|-------|-------|
| Option 1: FAN8100N | ![photo](<img width="640" height="640" alt="image" src="https://github.com/user-attachments/assets/31aeebd0-2281-4b88-b4e4-ec15abd9f2c3" />
) | [FAN8100N Datasheet](https://www.onsemi.com/) | $X.XX | Compact, logic-level, built-in protection | Must verify continuous current |
